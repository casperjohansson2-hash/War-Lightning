...
intro_sound = pygame.mixer.Sound("assets/audio/Match start.mp3")
...
player1_healthbar = HealthBar(
    ...
    filler2 = Image.new_image("assets/ui/hp_bar_health.png", pygame.Rect(10, 10, 215, 50)),
...
player2_healthbar = HealthBar(
    ...
    filler2 = Image.new_image("assets/ui/hp_bar_health.png", pygame.Rect(WIDTH-225, 10, 215, 50)),
    text = ui.Text(primary_font, "health", (255, 255, 255)),
