        ...
        if ui.get_mode() == "solo":
            ...
            while game:
                if countdown > 0:
                    ...
                    screen.blit(dim, (0, 0))
                    msg = "Capture!" if is_koth else "Fight!"
                    text_surf = other_font.render(f"{countdown-1}".replace("0", msg), True, (255, 255, 255))
        ...
        # =====================================================================
            ...
            while game:
                ...
                if is_koth:
                    ...
                    p1_text = score_font.render(f"P1: {p1_score}", True, (0, 255, 0))
                    p2_text = score_font.render(f"P2: {p2_score}", True, (255, 50, 50))
                    screen.blit(p1_text, (50, 100))
                    screen.blit(p2_text, (width - 250, 100))
