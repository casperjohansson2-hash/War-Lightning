    ...
    if ui.get_mode() == "exit":
        ...
        class Player1:
            ...
            def draw(self, screen):
                if not self.exploded:
                    ...
                    screen.blit(self.sprite_arrow, (self.arrow1_x, self.arrow1_y))
        ...
        if ui.get_kind() == "deathmatch":
            while game:
                ...
                if ui.get_mode() == "solo" and not player_2.exploded or ui.get_mode() == "bossmode" and not player_2.exploded:
