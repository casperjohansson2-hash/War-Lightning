...
while whole_game:
    ...
    if ui.get_mode() == "exit":
        ...
        if background == background1:
            ...
            broken_walls = [ # another unneccesary file
                pygame.Rect(255, 590, 86, 28), # 86, 28
                pygame.Rect(794, 255, 28, 80), # 28, 80
                ...
                pygame.Rect(936, 968, 84, 28), # 84, 28
            ]
        ...
        if ui.get_kind() == "deathmatch":
            while game:
                ...
                for bullet in reversed(bullet_list1.copy()):
                    bullet.move()
                    bullet.draw(screen)
